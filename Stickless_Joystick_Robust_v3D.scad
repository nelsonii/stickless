...
module contactSensor() {
  ...
  //slots for boards
  color("orangered") translate([-11.25, -(cutoutWidthX+4)/2, 7.5]) cube([1.5, cutoutWidthX+4, cutoutHeightZ+3.5]); //-X
  color("orangered") translate([+9.75, -(cutoutWidthX+4)/2, 7.5]) cube([1.5, cutoutWidthX+4, cutoutHeightZ+3.5]); //+X
  color("orangered") translate([-((cutoutWidthX+4)/2), +9.75, 7.5]) cube([cutoutWidthX+4, 1.5, cutoutHeightZ+3.5]); //+Y
  color("orangered") translate([-((cutoutWidthX+4)/2), -11.25, 7.5]) cube([cutoutWidthX+4, 1.5, cutoutHeightZ+3.5]); //+Y
