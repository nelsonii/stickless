...
module contact() {
  ...
  color("skyblue") tube(h=contactHeightZ, id=wall-3, wall=5);
...
module contactswitch(){
  ...
  color("orange") translate([-30, -switchWidthX/2, wallThickness-overlap]) cube([switchDepthY, switchWidthX, switchHeightZ+2]); //-X
  color("orange") translate([+11, -switchWidthX/2, wallThickness-overlap]) cube([switchDepthY, switchWidthX, switchHeightZ+2]); //+X
  color("orange") translate([-(switchWidthX/2), +11, wallThickness-overlap]) cube([switchWidthX, switchDepthY, switchHeightZ+2]); //+Y
  color("orange") translate([-(switchWidthX/2), -30, wallThickness-overlap]) cube([switchWidthX, switchDepthY, switchHeightZ+2]); //+Y
