...
module contactswitch(){
  ...
  translate([-30.5, -switchWidthX/2, wallThickness]) cube([switchDepthY, switchWidthX, switchHeightZ+2]); //-X
  ...
  translate([-(switchWidthX/2), -30.5, wallThickness]) cube([switchWidthX, switchDepthY, switchHeightZ+2]); //+Y
